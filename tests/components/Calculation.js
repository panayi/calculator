...
describe('(Component) Calculation', function () {
  ...
  it('should render calculation.input and calculation.output', function () {
    ...
    const inputDiv = R.find((div) => div.textContent.indexOf(calculation.input) > -1, divs)
    const outputDiv = R.find((div) => div.textContent.indexOf(calculation.output) > -1, divs)
